...
function RoomFallback() {
  return (
    <div className="glass relative h-full min-h-[26rem] overflow-hidden rounded-[2.5rem]" aria-label="Sahar coding in a pastel room">
      <div className="absolute inset-0 bg-[linear-gradient(135deg,#fff9f1_0%,#f5ece4_55%,#e9f5fc_100%)]" />
      ...
      <div className="absolute inset-x-0 bottom-0 h-[27%] bg-[#dfc6b1]/70" />
      <div className="absolute inset-x-[5%] bottom-[22%] h-7 rounded-xl bg-[#b77f5f] shadow-[0_12px_25px_rgba(96,64,52,.22)]" />
      <div className="absolute inset-x-[8%] bottom-[3%] h-[21%] rounded-t-xl bg-[#9f6d54] shadow-inner">
        <div className="absolute inset-x-[34%] top-5 h-px bg-[#c99675]" />
